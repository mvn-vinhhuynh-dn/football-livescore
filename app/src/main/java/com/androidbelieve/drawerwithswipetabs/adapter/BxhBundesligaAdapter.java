 ...
 */
public class BxhBundesligaAdapter extends RecyclerView.Adapter<BxhBundesligaAdapter.ViewHolder> {
    private Context mConText;
    private ArrayList<BXH> mDatas = new ArrayList<>();

    public BxhBundesligaAdapter(Context context, ArrayList<BXH> datas) {
        mConText = context;
        mDatas = datas;
    }
