 ...
 */
public class BigramheaderBundesliga implements StickyHeadersAdapter<BigramheaderBundesliga.ViewHolder> {

    private ArrayList<LTD> items = new ArrayList<>();

    public BigramheaderBundesliga(ArrayList<LTD> items) {
        this.items = items;
    }
