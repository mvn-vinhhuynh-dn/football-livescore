 ...
 */
public class InitalheaderBundesliga implements StickyHeadersAdapter<InitalheaderBundesliga.ViewHolder> {

    private ArrayList<LTD> mDatas = new ArrayList<>();

    public InitalheaderBundesliga(ArrayList<LTD> datas) {
        this.mDatas = datas;
    }
