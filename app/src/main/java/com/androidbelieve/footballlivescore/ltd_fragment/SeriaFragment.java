...
import com.androidbelieve.footballlivescore.stickyadapterSeria.SeriaAdapter;
 ...
 */
@EFragment(R.layout.ltd_seria_fragment)
public class SeriaFragment extends Fragment implements ItemStickyClick {
    private ArrayList<LTD> mDatas = new ArrayList<>();

    private StickyHeadersItemDecoration top;
    private StickyHeadersItemDecoration overlay;
    private SeriaAdapter personAdapter;

    @ViewById(R.id.recycle_ltd_seria)
    ...
    private void getLTD() {
        ...
        AuthApi.getLtdSeria(new Callback<LTD>() {
            @Override
    ...
    private void setAdapter() {
        personAdapter = new SeriaAdapter(getActivity(), mDatas, this);
    ...
    public void onResume() {
        super.onResume();
        mTracker.setScreenName("LTD-Seria Screen");
