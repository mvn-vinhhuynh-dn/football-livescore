 ...
 */
public class BXHPrimerLeagueAdapter extends RecyclerView.Adapter<BXHPrimerLeagueAdapter.ViewHolder> {
    private Context mConText;
    private ArrayList<BXH> mDatas = new ArrayList<>();

    public BXHPrimerLeagueAdapter(Context context, ArrayList<BXH> datas) {
        mConText = context;
        mDatas = datas;
    }
