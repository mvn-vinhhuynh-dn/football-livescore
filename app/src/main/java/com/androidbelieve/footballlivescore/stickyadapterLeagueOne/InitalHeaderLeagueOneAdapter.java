package com.androidbelieve.footballlivescore.stickyadapterLeagueOne;
 ...
 */
public class InitalHeaderLeagueOneAdapter implements StickyHeadersAdapter<InitalHeaderLeagueOneAdapter.ViewHolder> {

    private ArrayList<LTD> mDatas = new ArrayList<>();

    public InitalHeaderLeagueOneAdapter(ArrayList<LTD> datas) {
        this.mDatas = datas;
    }
