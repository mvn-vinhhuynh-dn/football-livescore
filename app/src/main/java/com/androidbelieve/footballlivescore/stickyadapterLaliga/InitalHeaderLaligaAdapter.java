 ...
 */
public class InitalHeaderLaligaAdapter implements StickyHeadersAdapter<InitalHeaderLaligaAdapter.ViewHolder> {

    private ArrayList<LTD> mDatas = new ArrayList<>();

    public InitalHeaderLaligaAdapter(ArrayList<LTD> datas) {
        this.mDatas = datas;
    }
