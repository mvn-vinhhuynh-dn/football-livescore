 ...
 */
public class BigramHeaderSeriaAdapter implements StickyHeadersAdapter<BigramHeaderSeriaAdapter.ViewHolder> {

    private ArrayList<LTD> items = new ArrayList<>();

    public BigramHeaderSeriaAdapter(ArrayList<LTD> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(ViewHolder headerViewHolder, int position) {
        ...
        Log.d("vvvv", items.get(0).getFixtures().get(position).getDate());
        try {
