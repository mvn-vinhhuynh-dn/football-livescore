 ...
 */
public class SchedulePlayingAdapter extends RecyclerView.Adapter<SchedulePlayingAdapter.ViewHolder> {
    private ArrayList<LtdFootballClub> mDatas = new ArrayList<>();
    private Context mContext;

    public SchedulePlayingAdapter(Context context, ArrayList<LtdFootballClub> datas) {
        mContext = context;
        mDatas = datas;
    }
