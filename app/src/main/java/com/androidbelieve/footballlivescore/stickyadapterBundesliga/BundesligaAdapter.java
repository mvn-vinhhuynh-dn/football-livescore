package com.androidbelieve.footballlivescore.stickyadapterBundesliga;
 ...
 */
public class BundesligaAdapter extends RecyclerView.Adapter<BundesligaAdapter.ViewHolder> implements OnRemoveListener, OnEditListener {
    private ItemStickyClick mListener;
    private Context mContext;
    private ArrayList<LTD> mDatas = new ArrayList<>();
    private List<FavoriteMatch> mFavorites;

    public BundesligaAdapter(Context context, ArrayList<LTD> personDataProvider, ItemStickyClick listener) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        if (mDatas.get(0).getFixtures().get(position).getAwayTeamName() != null) {
